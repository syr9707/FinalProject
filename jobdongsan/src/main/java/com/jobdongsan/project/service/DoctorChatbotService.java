...
@Service
public class DoctorChatbotService {
	public static String main(String voiceMessage) {
        String chatbotMessage = "";

        try {
            String apiURL = "https://1czdi21h0u.apigw.ntruss.com/custom/v1/7921/6a00863d29c3a933f1c60aba4bb6b3fe722780dd06bbefc5ea2e868ce27eef93";
            String secretKey = "ZnlTc0FtTGhzdUJ1TEl0VkFwRnNnU2pscndWZWhXWlk=";
...
//=> userId is a unique code for each chat user, not a fixed value, recommend use UUID. use different id for each user could help you to split chat history for users.
    ...
    public String tts(String message) {
        ...
        try {
            ...
            // post request
            String postParams = "speaker=nsujin&volume=5&speed=0&pitch=0&format=mp3&text=" + text;
            con.setDoOutput(true);
            DataOutputStream wr = new DataOutputStream(con.getOutputStream());
