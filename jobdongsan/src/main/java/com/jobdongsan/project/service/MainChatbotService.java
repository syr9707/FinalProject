...
public class MainChatbotService {
	public static String main(String voiceMessage) {
        String chatbotMessage = "";

        try {
            String apiURL = "https://1czdi21h0u.apigw.ntruss.com/custom/v1/7920/a3309dc45148cffe447d9e57d71cf6ff7813f830a9f57a880a913ce63f5f6f6f";
            String secretKey = "WEFISkdpalpvTHhLR0lRTVltRFpoV2pQUXNtVGNnckM=";
