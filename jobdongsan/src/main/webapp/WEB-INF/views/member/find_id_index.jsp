				...
				<div class="section_wrap">
                    ...
                    <p>이메일</p>
                        ...
                        <div class="email_input" class="email_input">
                            <input type="text" name="email1" class="email1" value="aaa">@
                            <input type="text" name="email2" class="email2" placeholder="직접 입력" value="naver.com">
                        ...
                        <input type="button" name="email_code" class="email_code" value="이메일로 코드 발송하기">
                        ...
                        <input type="text" name="code" class="code">
                   		...
                   		<input type="button" name="code_check" class="code_check" value="확인">
